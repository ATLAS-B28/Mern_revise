 ...
 * @returns {React.ReactElement} - A single product card component.
 * @example
 * <ProductCard product={{name: "Apple", price: 1.99, image: "https://example.com/apple.jpg"}}/>
 */
const ProductCard = ({product}) => {
    ...
    /**
     * Deletes a product with id pid from the server and displays a toast notification
     * with the result.
    ...
    /**
     * Updates a product with id pid on the server and displays a toast notification
     * with the result.
